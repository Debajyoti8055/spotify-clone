    ...
    return track ? (
        ...
        <div className='h-[10%] bg-black flex justify-between items-center text-white px-4 '>
            <div className='hidden lg:flex items-center gap-4'>
                <img className='w-12' src={track.image} alt="" /> {/* initially this track will be on the Display */}
                <div>
                    <p>{track.name}</p>
            ...
            <div className='flex flex-col items-center gap-1 m-auto'>
                <div className='flex items-center gap-4'>
                    ...
                    {
                        playStatus ? <img onClick={pause} className='w-4' src={assets.pause_icon} alt="" /> : <img onClick={play} className='w-4' src={assets.play_icon} alt="" />
                    }
