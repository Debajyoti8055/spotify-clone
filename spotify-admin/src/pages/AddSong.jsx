...
const AddSong = () => {
    ...
    return loading ? (
        ...
        <form onSubmit={onSubmitHandler} className='flex flex-col item-start gap-8 text-gray-600' action="">
            ...
            <div className='flex flex-col gap-2.5'>
                <p>Album</p>
                <select onChange={(e) => setAlbum(e.target.value)} defaultValue={album} className="bg-transparent outline-green-600 border-2 border-gray-400 p-2.5 w-[150px]" name="" id="">
            ...
            <button type='submit' className='text-base bg-black text-white py-2.5 px-14 cursor-pointer w-[150px]'>
                ADD
            </button>
        </form>
    )
